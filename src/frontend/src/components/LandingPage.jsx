 ...
 * `isDarkMode` / `toggleTheme` accepted for App compatibility; theme is toggled from the main app chrome when user enters.
 */
const LandingPage = ({ onEnterApp }) => {
    return (
        <div className="landing-page min-h-screen bg-transparent font-sans text-gray-900 dark:text-gray-100">
            <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 pb-16 pt-[max(1rem,env(safe-area-inset-top))] sm:gap-5 sm:px-6 sm:pb-20 sm:pt-6 lg:gap-6 lg:px-8">
                ...
                <section className="relative min-w-0">
                    ...
                    />
                    <div
                        className={`${LG_HERO} relative w-full min-w-0 max-w-full px-6 py-[calc(1.5rem-0.5cm)] sm:px-8 sm:py-[calc(2rem-0.5cm)] lg:grid lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)] lg:items-center lg:gap-8 lg:px-7 lg:py-[calc(1.75rem-0.5cm)] xl:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)] xl:px-8 xl:py-[calc(2rem-0.5cm)]`}
                    >
                        <div
