    ...
    <FeaturePageShell>
      <div className="animate-in fade-in relative pb-12 duration-700">
        ...
        <div className="relative mx-auto w-full max-w-7xl space-y-tile">
          ...
          <section
            className="rounded-2xl border border-lex bg-white/90 p-5 shadow-sm dark:border-lex dark:bg-zinc-900/80"
            aria-labelledby="about-legal-cta"
          >
            <h2 id="about-legal-cta" className="text-base font-bold text-slate-900 dark:text-white sm:text-lg">
              Terms, privacy &amp; DPA
            </h2>
            <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
              The full text of our terms, copyright, AI digests, disclaimers, and privacy (including Clerk) lives on a
              dedicated public page. Use the same link in Clerk and for compliance.
            </p>
            <Link
              to="/legal"
              className="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-violet-700 underline decoration-violet-500/30 underline-offset-2 transition hover:decoration-violet-500 dark:text-violet-400"
            >
              Open <span className="font-mono text-xs sm:text-sm">/legal</span> — legal information &amp; terms of use
            </Link>
          </section>
        </div>
      </div>
