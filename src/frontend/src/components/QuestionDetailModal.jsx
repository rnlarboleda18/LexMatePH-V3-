    ...
    return createPortal(
        <div className="fixed inset-0 z-[540] lex-modal-overlay bg-black/60 backdrop-blur-md animate-in fade-in duration-200" onClick={handleClose}>
            ...
            >
                ...
                {/* Header: headphones + subject left · year + close right (same chrome height as bottom nav row) */}
                <div className="relative z-10 flex min-h-[2.75rem] shrink-0 items-center justify-between gap-2 border-b border-lex bg-neutral-50 px-1.5 py-1.5 dark:border-lex dark:bg-zinc-950 sm:min-h-[3rem] sm:px-2 md:px-3">
                ...
                {/* Bar question nav: same chrome height as header — Previous left, Next right */}
