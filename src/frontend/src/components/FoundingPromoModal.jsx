...
export default function FoundingPromoModal({ onClose }) {
      ...
      >
        ...
        <div className="relative z-10 px-6 py-6">
          ...
          <p className="mb-3 text-[17px] font-extrabold leading-snug text-gray-900 dark:text-white">
            ...
            <span className="text-amber-500 dark:text-amber-400">FREE 30-day Barrister trial</span>{' '}
            as part of our Founding Promo.
          </p>

          <p className="mb-5 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
            As one of our earliest users, you get full Barrister access — unlimited case digests,
            LexPlay, Lexify bar simulator, and more — completely free for 30 days. Slots are
            limited, so claim yours now before they run out.
          </p>
          ...
          >
            Claim My Free Trial — Sign Up Now →
          </button>
          ...
          <p className="mt-4 text-center text-[11px] text-gray-400 dark:text-gray-600">
            No credit card required · Trial applied automatically on sign-up
          </p>
        </div>
      </div>
    </div>,
