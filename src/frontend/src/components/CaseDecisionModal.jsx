                    ...
                    {viewMode === 'digest' ? (
                        <>
                             {fullDecision.main_doctrine && (
                                <div className={`relative mb-8 overflow-hidden rounded-2xl border border-lex bg-gradient-to-br ${doctrinePanel.card} p-4 shadow-md sm:mb-10 dark:border-lex sm:p-6 md:p-8`}>
