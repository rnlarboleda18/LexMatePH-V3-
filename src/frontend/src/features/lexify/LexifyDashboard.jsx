    ...
    return (
        <FeaturePageShell>
            ...
            <div className="mx-auto w-full max-w-5xl flex-1 overflow-y-auto px-4 py-4 sm:px-6">
                ...
                {activeTab === 'exams' ? (
                    <>
                        <div className="lexify-hero-in relative mb-8 overflow-hidden rounded-lg border border-lex bg-white px-5 py-8 text-center shadow-md dark:border-lex dark:bg-zinc-900 sm:px-8">
                            <div
                                className="lexify-orb-drift pointer-events-none absolute -right-8 -top-12 h-36 w-36 rounded-full bg-gradient-to-br from-purple-400/30 to-fuchsia-500/20 blur-2xl"
                                aria-hidden
                                style={{ animationDelay: '-2s' }}
                            />
                            <div
                                className="lexify-orb-drift pointer-events-none absolute bottom-0 left-1/4 h-24 w-48 rounded-full bg-violet-400/15 blur-2xl"
                                aria-hidden
                            ...
                            <div className="relative mx-auto inline-flex items-center gap-2 rounded-full border border-lex bg-white px-3 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-purple-800 shadow-sm dark:border-lex dark:bg-zinc-800/90 dark:text-purple-200">
                                <Sparkles className="lexify-sparkle-wink h-3.5 w-3.5 text-purple-600 dark:text-purple-300" aria-hidden />
