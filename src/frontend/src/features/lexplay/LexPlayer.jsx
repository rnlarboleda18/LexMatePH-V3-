                        ...
                        >
                            ...
                            >
                                {isLoading ? (
                                    ...
                                    <>
                                        <div className="flex h-4 items-end justify-center gap-0.5 group-hover:hidden" aria-hidden>
                                            {[0.4, 1.0, 0.7, 0.5].map((h, i) => (
                                                <div
                                                    key={i}
