...
Write-Host "Launching Modern Fleet V3 (1990-2025) with $numWorkers Workers (Key ...WVDI)..." -ForegroundColor Cyan

for ($i = 1; $i -le $numWorkers; $i++) {
    Write-Host "Starting Modern Worker V3 #$i..." -ForegroundColor Green
