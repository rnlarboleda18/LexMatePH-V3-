# RPC + ROC codal linker: decision years 2010 down to 1997 (resume-safe per year).
try { chcp 65001 | Out-Null } catch { }
$Host.UI.RawUI.WindowTitle = "LexMate linker RPC+ROC 2010-1997"
...
$log = Join-Path $PSScriptRoot "unified_linker_rpc_roc_2010_1997.log"
for ($y = 2010; $y -ge 1997; $y--) {
...
Write-Host "`n========== ALL YEARS DONE (RPC+ROC 2010-1997) ==========`n"
