...
# Uses Vertex AI (gemini-2.5-flash), project gen-lang-client-0813708151 (rnlarboleda8).
...
foreach ($y in 2003, 2002, 2001) {
    ...
    python -u unified_codal_linker.py --year $y --statutes AM-01-7-01-SC --workers 5 --commit --vertex-project gen-lang-client-0813708151 2>&1 | Tee-Object -FilePath $log -Append
