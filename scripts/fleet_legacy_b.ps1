...
$appArgs = "--start-year 1946 --end-year 1989 --continuous --limit 500 --model $model"

Write-Host "Launching Legacy Fleet B (1946-1989) with $numWorkers Workers (Lite) - New Key..." -ForegroundColor Cyan

for ($i = 1; $i -le $numWorkers; $i++) {
    Write-Host "Starting Legacy B Worker #$i..." -ForegroundColor Green
