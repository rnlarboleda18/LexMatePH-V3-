...
files = [
    "data/LexCode/Codals/md/ca_99_1936.md",
    "data/LexCode/Codals/md/ca_235_1937.md",
    "data/LexCode/Codals/md/ra_12_1946.md",
    "data/LexCode/Codals/md/ra_18_1946.md"
]
...
for file_path in files:
    ...
    cmd = [sys.executable, "data/LexCode/scripts/process_amendment.py", "--file", full_path]
