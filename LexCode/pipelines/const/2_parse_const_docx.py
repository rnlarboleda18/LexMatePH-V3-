...
DOCX_PATH = os.path.join(BASE_DIR, "LexCode", "Codals", "Word", "1987 Philippine Constitution.docx")
OUTPUT_PATH = os.path.join(BASE_DIR, "LexCode", "Codals", "md", "CONST_structured.md")
