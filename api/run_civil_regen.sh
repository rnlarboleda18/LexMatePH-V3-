...
TOPICS=(I.A I.B I.C I.D I.E I.F I.G I.H I.I I.J II.A II.B III.A III.B IV.A IV.B V.A V.B V.C VI.A VI.B VI.C VI.D VI.E VI.F VI.G VI.H VI.I VI.J VI.K VII.A VII.B VII.C VII.D VII.E VII.F VIII.A VIII.B IX.A IX.B IX.C IX.D X.A X.B X.C XI.A XI.B XI.C XI.D XI.E XI.F XI.G XII.A XII.B XII.C XII.D)
TOTAL=${#TOPICS[@]}

log "=== Civil law regen: $TOTAL topics | project: $GOOGLE_CLOUD_PROJECT ==="
log "Log: $LOG"
